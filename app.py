...
st.set_page_config(page_title="Customer Feedback Sentiment Analyzer", layout="centered")

st.title("📊 Customer Feedback & Aspect Sentiment Analyzer")
st.write("Enter a course review or customer feedback below to analyze its sentiment and extract aspect-level breakdown.")
...
user_review = st.text_area("Customer Review / Feedback", placeholder="Type or paste review here...", height=150)
